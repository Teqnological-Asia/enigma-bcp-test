...
class GoToLogin extends Component {
  ...
  bodyText = {
    ...
    maintenance: "ただいまの時間帯はシステムメンテナンス中のため、お客さまサポートWEBはご利用いただけません。<br/> <br/>＜メンテナンス時間＞<br/> <br/>月曜日～土曜日・祝日：AM3:30～AM5:30頃<br/>日曜日：AM3:30～AM7:30頃<br/> <br/>※上記以外の時間でも臨時でメンテナンスを行う場合がございます。<br/>臨時メンテナンスについてはコレカブトップのお知らせページをご確認ください。",
