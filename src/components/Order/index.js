      ...
      <div className="l-contents_body_inner">
        ...
        <div className="u-mt40p">
          <div className="p-section_lead">
            <p>※　当緊急時取引メニューは、現物株式の「売却」の受付のみに限定させていただいております。上記の注文照会画面に「現物買」注文が表示されて
              いる場合がありますが、「取消」をされた場合、再度発注することはできませんので、あらかじめご了承願います。</p>
            <p>※　注文の訂正はできません。訂正する場合には一旦注文の取消後、再度注文（現物株式の売却）を発注ください。</p>
          </div>
        </div>
      </div>
    )
